...
void UCFO::SetContact_TouchdownPoints(bool pBrake){
    ...
    if(pBrake == false){
        ...
        td_points[0] = {front_right_wheel_contact, front_stiffness, front_damping, 1.0, 1.0};
        td_points[1] = {front_left_wheel_contact, front_stiffness, front_damping, 1.0, 1.0};
        td_points[2] = {rear_right_wheel_contact, rear_stiffness, rear_damping, 1.0, 1.0};
        td_points[3] = {rear_left_wheel_contact, rear_stiffness, rear_damping, 1.0, 1.0};
